      ...
      <div className="box-auth">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div id="signUpAsAdmin">
            <label className="checkbox" htmlFor="signUpAsCaterer">
            Sign up as Caterer
              <input id="signUpAsCaterer" value={this.state.checked ? 'customer' : 'caterer'} onChange={this.onCheckBoxChange} checked={this.state.checked} type="checkbox" /><span className="check" />
            </label>
          </div>
