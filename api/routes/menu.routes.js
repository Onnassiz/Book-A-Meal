...
export default function menuRoutes(app) {
  ...
  app.post('/menus', verifyAuthToken, validateCatererToken, menuFormConstraints, validateFormData, MenuController.verifyMealsInMenu, MenuController.postMenu, MenuController.mapMenusToMeals);
  app.put('/menus/:id', verifyAuthToken, validateCatererToken, validParamId, menuUpdateFormConstraints, validateFormData, MenuController.verifyMealsInMenu, MenuController.putMenu);
